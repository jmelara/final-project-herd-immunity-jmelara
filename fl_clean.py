...
#read csv into file under variable florida
florida = pd.read_csv("COVID-19_Case_Geography_FL.csv", dtype = str)

#print columns
print("Columns" , list(florida.columns))

#drop any columns with missing variables using .dropna() on fl
florida.dropna()
...
florida.drop(drop, axis = "columns" , inplace =True)

florida.to_csv("COVID-19_Case_Geography_FL_CLEAN.csv")
